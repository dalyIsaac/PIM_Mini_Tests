...
def main():
    ...
    if COMMS_TESTS:
        ...
        from comms_controller import main as comms_main
        comms_main()
    if LEDS_TESTS:
        # NOTE: Runs on the PIM Mini
        from leds_controller import main as leds_main
        leds_main()
    if USER_INPUTS_TESTS:
        # NOTE: Runs on the PIM Mini
        from user_inputs_controller import main as user_inputs_main
        user_inputs_main()
